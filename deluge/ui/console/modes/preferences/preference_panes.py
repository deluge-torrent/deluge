...
class QueuePane(BasePreferencePane):
    ...
    def create_pane(self, core_conf, console_config):
        ...
        self.add_checkedplus_input('stop_seed_at_time', '%s:' % _('Seed Time Reached'), seedtime,
                                   core_conf['stop_seed_at_time'])
        self.add_checked_input('remove_seed_at_time', _('Remove torrent (Unchecked pauses torrent)'),
                               core_conf['remove_seed_at_time'])
