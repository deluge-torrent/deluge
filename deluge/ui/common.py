...
TORRENT_DATA_FIELD = {
    ...
    'stop_at_seed_time':
        {'name': _('Stop after seeding (days)'), 'status': ['stop_at_seed_time']},
    'stop_seed_time':
        {'name': _('Seeding Time (days)'), 'status': ['stop_seed_time']},
    'remove_at_seed_time':
        {'name': _('Remove after seeding (days)'), 'status': ['remove_at_seed_time']},
    'move_completed':
