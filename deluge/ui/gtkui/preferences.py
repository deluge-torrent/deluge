...
class Preferences(component.Component):
    ...
    def _show(self):
        ...
        core_widgets = {
            ...
            'chk_seed_time': ('active', 'stop_seed_at_seed_time'),
            'spin_seed_time': ('value', 'stop_seed_time'),
            'radio_pause_seed_time': ('not_active', 'remove_seed_at_seed_time'),
            'radio_remove_seed_time': ('active', 'remove_seed_at_seed_time'),
    ...
    def set_config(self, hide=False):
        ...
        new_core_config['stop_seed_at_seed_time'] = self.builder.get_object('chk_seed_time').get_active()
        new_core_config['remove_seed_at_seed_time'] = self.builder.get_object(
            'radio_remove_seed_time').get_active()
        new_core_config['stop_seed_time'] = self.builder.get_object('spin_seed_time').get_value()
    ...
    def on_toggle(self, widget):
        ...
        dependents = {
            ...
            'chk_seed_time': {'spin_seed_time': True,
                                'radio_pause_seed_time': True,
                                'radio_remove_seed_time': True}
        }
