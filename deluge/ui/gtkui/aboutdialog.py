...
class AboutDialog:
    def __init__(self):
        ...
        self.about.set_authors(["Andrew Resch", "",
            "NullUI (replaced by ConsoleUI):", "Sadrul Habib Chowdhury", "", "WebUI:", "Martijn Voncken", "", "ConsoleUI:", "Ido Abramovich", "", "AjaxUI:", "Damien Churchill", "", "libtorrent (www.libtorrent.org):", "Arvid Norberg", "", "Past Developers:", "Zach Tibbits", "Alon Zakai", "Marcos Pinto", "Alex Dedul"])
