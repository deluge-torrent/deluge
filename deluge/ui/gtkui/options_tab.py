...
class OptionsTab(Tab):
    def __init__(self):
        ...
        self.add_tab_widget('chk_remove_at_time', 'active', ['remove_at_time'])
    ...
    def on_get_torrent_status(self, new_status):
        ...
        if new_status != self.prev_status:
            ...
            self.tab_widgets['spin_stop_time'].obj.set_sensitive(new_status['stop_at_time'])
            self.tab_widgets['chk_remove_at_time'].obj.set_sensitive(new_status['stop_at_time'])
...
# === Widget signal handlers === #
    ...
    def on_chk_stop_at_time_toggled(self, widget):
        ...
        self.tab_widgets['chk_remove_at_time'].obj.set_sensitive(widget.get_active())
        self.on_chk_toggled(widget)
