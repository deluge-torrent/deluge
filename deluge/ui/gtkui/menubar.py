...
class MenuBar(component.Component):
    ...
    def __init__(self):
        ...
        submenu = gtk.Menu()
        item = gtk.MenuItem(_('Disable'))
        item.connect('activate', self.on_menuitem_set_stop_seed_at_seed_time_disable)
        submenu.append(item)
        item = gtk.MenuItem(_('Enable...'))
        item.set_name('menuitem_stop_seed_at_seed_time')
        item.connect('activate', self.on_menuitem_set_other)
        submenu.append(item)
        submenu.show_all()
        self.builder.get_object('menuitem_stop_seed_at_seed_time').set_submenu(submenu)
    ...
    def on_menuitem_set_other(self, widget):
        ...
        status_map = {
            ...
            'menuitem_stop_seed_at_seed_time': ['stop_seed_time', 'stop_seed_time']
        }
        ...
        other_dialog_info = {
            ...
            'menuitem_stop_seed_at_seed_time': [_('Stop Seed After (days)'), 'Stop torrent seeding after', 'days', None]
        }
        ...
        def _on_torrent_status(status):
            ...
            def set_value(value):
                if value is not None:
                    ...
                    elif core_key == 'stop_seed_time':
                        options['stop_at_seed_time'] = True
    ...
    def on_menuitem_set_stop_seed_at_seed_time_disable(self, widget):
        client.core.set_torrent_options(component.get('TorrentView').get_selected_torrents(),
