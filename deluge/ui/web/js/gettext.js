...
GetText.add('Remove after seeding (days)','${escape(_("Remove after seeding (days)"))}')
GetText.add('Remove torrent','${escape(_("Remove torrent"))}')
GetText.add('Resume','${escape(_("Resume"))}')
GetText.add('Save','${escape(_("Save"))}')
GetText.add('Seed Time Reached','${escape(_("Seed Time Reached"))}')
GetText.add('Seed Time:','${escape(_("Seed Time:"))}')
...
GetText.add('Stop after seeding (days):','${escape(_("Stop after seeding (days):"))}')
