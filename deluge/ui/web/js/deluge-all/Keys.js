...
Deluge.Keys = {
     ...
     *  'is_auto_managed', 'stop_at_ratio', 'stop_ratio', 'remove_at_ratio', 'stop_at_seed_time', 'stop_seed_time',
     *  'remove_at_seed_time', 'private', 'prioritize_first_last']</pre>
     */
    Options: [
        'max_download_speed', 'max_upload_speed', 'max_connections',
        'max_upload_slots','is_auto_managed', 'stop_at_ratio', 'stop_ratio',
        'remove_at_ratio', 'stop_at_seed_time', 'stop_seed_time', 'remove_at_seed_time',
        'private', 'prioritize_first_last', 'move_completed', 'move_completed_path'
    ]
};
