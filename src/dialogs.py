...
class PreferencesDlg:
	...
	def show(self):
		...
		try:
			...
			self.glade.get_widget("chk_web_seed_proxy").set_active(self.preferences.get("web_seed_proxy"))
		...
		if r == 1:
			...
			self.preferences.set("web_seed_proxy", self.glade.get_widget("chk_web_seed_proxy").get_active())
